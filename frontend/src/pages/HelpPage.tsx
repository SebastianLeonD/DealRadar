  ...
  return (
    <div className="mx-auto max-w-3xl">
      ...
      <Section title="Your daily routine">
        <ol className="list-none space-y-3 pl-0">
          {[
            ...
            ["Press “Run everything” on the Update Data tab.", "It downloads bookmaker lines, reads your PrizePicks file, and produces verdicts on The Board. Takes under a minute."],
      ...
      <Section title="What the verdicts mean">
        <div className="space-y-3">
          ...
          <div className="flex items-start gap-3">
            ...
            <p className="text-sm">
              Below break-even. These never even appear on The Board — no pick shown means
              the answer was no.
            </p>
          </div>
        </div>
      ...
      <Section title="Common questions">
        ...
        <Faq q="Nothing shows on The Board — is it broken?">
          <p>
