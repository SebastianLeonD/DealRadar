...
try:
    with open('data/processed/draftkings_data.json', 'r') as f:
        clean_picks = json.load(f)
except FileNotFoundError:
    print("Error: Could not find data/processed/draftkings_data.json. Run scrapers/draftkings_api.py first to create it.")
    exit()
...
for line in sorted_odds:
    # Use fallback .get() for 'Stat' in case you haven't rerun draftkings_api yet
